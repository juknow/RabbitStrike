...
public class LongPlayerController : MonoBehaviour, IController
{
    ...
    void Start()
    {
        ...
        myHP = NewDataManager.Instance.LongPlayerHP;
        moveSpeed = NewDataManager.Instance.LongPlayerMoveSpeed;
